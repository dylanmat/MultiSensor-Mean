...
metadata {
    definition(name: deviceName(), namespace: "multisensor.mean", author: "OpenAI Assistant") {
        capability "Sensor"
...
void installed() {
    logInfo "Installed ${deviceName()}"
}

void updated() {
    logInfo "Updated ${deviceName()}"
    if (logEnable) {
        runIn(1800, "logsOff")
    }
}
...
private String deviceName() {
    return "${APP_NAME_BASE} Child Device"
}
